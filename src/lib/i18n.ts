...
export const ui = {
  ...
  videoSectionTitle: s('Video', 'الفيديو'),
  videoIntro: s('A walkthrough of the residence, as filmed on site.', 'جولة مصوّرة في المسكن كما صُوّرت في الموقع.'),
  videoLabel: s('Video {n} — {title}', 'الفيديو {n} — {title}'),
